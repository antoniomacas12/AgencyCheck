...
const AGENCYCHECK_BENEFITS = [
  { icon: "⚡", label: "Odpowiedź tego samego dnia", detail: "Aplikuj przez WhatsApp i otrzymaj odpowiedź od prawdziwego rekrutera jeszcze tego samego dnia roboczego — typowy czas reakcji to kilka godzin. Zatrudnienie przez agencję w Holandii może rozpocząć się już 7–14 dni od pierwszego kontaktu. Żadnych tygodni oczekiwania, żadnych automatycznych botów." },
  { icon: "🏠", label: "Mieszkanie z certyfikatem SNF", detail: "Wszystkie agencje na AgencyCheck oferują zakwaterowanie jako część pakietu — nie musisz szukać własnego lokum w nieznanym kraju. Sprawdź czy agencja posiada certyfikat SNF (Stichting Normering Flexwonen) weryfikowalny na snf.nl: oznacza to, że maksymalne potrącenie za mieszkanie wynosi €113,50/tydzień (norma 2026), a warunki spełniają niezależne standardy jakości." },
  { icon: "📋", label: "Przejrzysta umowa przed wyjazdem", detail: "Zanim podpiszesz — widzisz dokładnie co będzie odliczane: mieszkanie, transport (osobna pozycja na loonstrook: €20–€30/tydz.), ubezpieczenie zdrowotne. Zgodnie z holenderskim prawem WAADI agencja nie może pobierać od Ciebie opłaty za znalezienie pracy. Jeśli agencja żąda zaliczki lub opłaty rekrutacyjnej — to sygnał alarmowy." },
  { icon: "🆓", label: "Całkowicie bezpłatne dla pracownika", detail: "AgencyCheck jest w 100% bezpłatny dla pracowników — holenderskie prawo WAADI zakazuje pobierania od pracowników opłat za pośrednictwo. Agencje w naszej bazie są zarejestrowane w KvK (Holenderska Izba Handlowa) i należą do ABU lub NBBU. Ty nie płacisz nic i nie ma żadnych ukrytych prowizji." },
];

// ─── Agency offers (PL) ──────────────────────────────────────────────────────
const AGENCY_OFFERS = [
  { icon: "📄", title: "Pisemna umowa przed startem", body: "Dobra agencja zawsze daje pisemną umowę z wyprzedzeniem — zanim w ogóle wyjedziesz z Polski. Umowa powinna zawierać: stawkę godzinową (min. WML €14,71/h), koszt zakwaterowania, datę startu oraz informację o fazie CAO (Faza A obowiązuje przez pierwsze 78 tygodni). Polacy pracują głównie w Tilburgu, Venlo i Rotterdamie — upewnij się, że wiesz do którego miasta jedziesz." },
  { icon: "🏠", title: "Certyfikowane zakwaterowanie SNF", body: "Najlepsze agencje posiadają certyfikat SNF (Stichting Normering Flexwonen) weryfikowalny pod adresem snf.nl — niezależny holenderski standard jakości mieszkań pracowniczych z maksymalną stawką €113,50/tydzień (2026). Transport do mieszkania powinien być osobną pozycją na loonstrook (odcinku płacowym), a nie ukrytą opłatą. Sprawdź certyfikat przed podpisaniem umowy." },
  { icon: "⏱", title: "Nadgodziny prawidłowo opłacane", body: "Zgodnie z ABU/NBBU CAO nadgodziny (overwerktoeslag) są wyceniane wyżej: 125% stawki w dni powszednie i 150% w niedziele oraz święta. Dobre agencje stosują to automatycznie i pokazują wyraźnie na loonstrook (odcinku płacowym). Brak odrębnej pozycji overwerktoeslag przy przepracowanych nadgodzinach to sygnał alarmowy — zgłoś to do Inspectie SZW." },
  { icon: "🚌", title: "Transport i rejestracja BSN", body: "Większość agencji organizuje transport do miejsca pracy — koszt to zazwyczaj €20–€30/tydzień i musi figurować jako osobna pozycja w umowie. Po przyjeździe do Holandii będziesz potrzebować numeru BSN (burgerservicenummer) — to odpowiednik polskiego PESEL, wymagany do rozliczeń podatkowych. Agencja powinna pomóc umówić wizytę w gminie (gemeente). Ważne: w Holandii płacisz do holenderskiego systemu ubezpieczeń, a nie do ZUS." },
  { icon: "💬", title: "Wsparcie w języku polskim", body: "Dobra agencja ma pracowników mówiących po polsku — pytaj o to wprost przy pierwszym kontakcie. Możesz też korzystać z regulacji ET (extraterritoriale kosten): niektórzy pracownicy z zagranicy kwalifikują się do zwrotu kosztów delegacyjnych zwolnionego z podatku. Zapytaj agencję, czy stosuje ten benefit — legalne agencje chętnie to wyjaśniają." },
];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-7">
          ...
          <div className="border-t border-white/5 pt-4">
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
              <span className="text-[9px] font-black uppercase tracking-widest text-gray-300 shrink-0">Źródła danych:</span>
              {[
            ...
            <div className="p-6 space-y-3">
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-xs font-bold text-gray-300">Co agencja reklamuje (brutto)</span>
                  <span className="text-sm font-black text-white">€588/tydzień</span>
                </div>
                <div className="h-3 rounded-full bg-white/15 w-full" />
              </div>
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-xs font-bold text-gray-300">Po holenderskim podatku (z ulgami heffingskorting)</span>
                  <span className="text-sm font-black text-gray-200">€525/tydzień</span>
                </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-7">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500 leading-relaxed max-w-xl">
                <span className="font-semibold text-gray-200">Przejrzyste potrącenia</span> ·{" "}
                <span className="font-semibold text-gray-200">Zweryfikowane zakwaterowanie</span> ·{" "}
                <span className="font-semibold text-gray-200">Prawdziwe opinie pracowników</span>{" "}
      ...
      <section className="bg-[#0a111e] border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-white">Jak obliczamy Twoje realne wynagrodzenie</h2>
          </div>
      ...
      <section className="bg-[#0a111e] border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-white mb-4">Co zawierają oferty najlepszych agencji</h2>
      ...
      <section className="bg-[#0d1728] border-b border-white/[0.05]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          <div className="text-center mb-9">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-white mb-3">Zobacz, gdzie naprawdę będziesz mieszkać</h2>
                  ...
                  <div className="px-5 py-4 flex-1 space-y-3">
                    ...
                    <div className="space-y-1.5 text-xs text-gray-500">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-bold text-gray-200">€{meta?.housingCost ?? 95}/tydz.</span>
                      </div>
                      <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-bold text-gray-200">{meta?.responseTime ?? "< 24 godziny"}</span>
                      </div>
                    </div>
                  </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-sm text-gray-300 leading-relaxed">
                <p>
                  ...
                  <strong className="text-white">€14,71/godzinę w 2026 roku</strong> dla pracowników
                ...
                <p>
                  Kluczowe zabezpieczenia prawne, które warto znać: <strong className="text-white">ABU / NBBU CAO</strong>{" "}
                  reguluje stawki wynagrodzenia, premie za nadgodziny i wynagrodzenie urlopowe.
                  <strong className="text-white"> SNF</strong> (Stichting Normering Flexwonen) określa maksymalne prawne
                  potrącenia za zakwaterowanie. <strong className="text-white">Inspectie SZW</strong> egzekwuje całe prawo pracy.
      ...
      <section className="bg-[#0d1728] border-b border-white/[0.05]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white">Pytania, które pracownicy naprawdę zadają</h2>
          </div>
          <HomepageFAQ />
