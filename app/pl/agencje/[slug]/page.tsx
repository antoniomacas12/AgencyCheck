...
export async function generateMetadata({
  ...
  // Apply the same quality gate as the EN page — noindex thin/low-data agencies.
  // DB-only agencies (not in verified dataset) default to noindex on locale pages.
      ...
      <section className="mb-8">
        ...
        {directReviews.length > 0 ? (
          ...
          <HeroReviewInline
            ...
            beFirst
            labels={{
              heading:        "✍️ Pracowałeś/-aś w tej agencji? Pomóż innym",
              placeholder:    "Jak wyglądało zakwaterowanie, wynagrodzenie, zarządzanie?",
              submit:         "Wyślij opinię →",
              successTitle:   "Opinia wysłana!",
              successSub:     "Dziękujemy. Twoja opinia jest już widoczna na stronie recenzji.",
              beFirstHeading: `Bądź pierwszą osobą, która oceni ${agencyName}`,
              beFirstSub:     "Pracownicy tacy jak Ty polegają na szczerych opiniach, by unikać złych agencji. Zajmuje to 30 sekund.",
            }}
          />
        )}
      </section>
