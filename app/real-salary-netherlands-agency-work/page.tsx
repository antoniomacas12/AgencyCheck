    ...
    <div className="min-h-screen bg-[#0B1F14] text-white">
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <nav className="text-xs text-gray-400 mb-5 flex items-center gap-1.5 flex-wrap">
          ...
          <span>›</span>
          <Link href="/salary-guides" className="hover:text-emerald-400">Salary Guides</Link>
          <span>›</span>
          <span className="text-gray-300 font-medium">Agency Work Salary Reality</span>
        </nav>
        ...
        <div className="rounded-xl border border-white/[0.07] bg-white/[0.04] p-6 mb-6">
          <h2 className="text-xl font-bold text-white mb-3">Starting Point: The 2026 Minimum Wage</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
            The <strong className="text-white">Wettelijk Minimumloon (WML)</strong> — Statutory Minimum Wage — for 2026
            is <strong className="text-white">€14.71 gross per hour</strong> for workers aged 21 and over. This applies
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              {[
                ...
                <div key={label}>
                  ...
                  <p className="text-xl font-extrabold text-emerald-400 mt-0.5">{value}</p>
        ...
        <div className="rounded-xl border border-white/[0.07] bg-white/[0.04] p-6 mb-6">
          <h2 className="text-xl font-bold text-white mb-3">The Complete Deduction Path: Gross to Net</h2>
          ...
          <div className="rounded-xl overflow-hidden border border-white/[0.10]">
            {[
              ...
              <div key={label} className={`flex items-start justify-between gap-3 px-4 py-3 border-b border-white/[0.07] last:border-0 ${type === "final" ? "bg-emerald-900/30" : ""}`}>
                <div>
                  <p className={`text-sm ${type === "final" ? "font-bold text-white" : "text-gray-200"}`}>{label}</p>
                  {note && <p className="text-xs text-gray-400 mt-0.5">{note}</p>}
                </div>
                <span className={`text-sm font-mono shrink-0 ${
                  type === "deduct" ? "text-red-400" :
                  type === "add" ? "text-emerald-400" :
                  type === "final" ? "font-bold text-emerald-300 text-base" :
        ...
        {/* Shift premiums */}
        <div className="rounded-xl border border-white/[0.07] bg-white/[0.04] p-6 mb-6">
          <h2 className="text-xl font-bold text-white mb-3">How Shift Premiums Change the Picture</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={shift} className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 bg-white/[0.04] border border-white/[0.07] rounded-xl p-4">
                <div>
                ...
                <div className="flex gap-4 text-sm text-right">
                  <div>
                    ...
                    <p className="font-bold text-emerald-400">{premium}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Est. gross/wk</p>
                    <p className="font-semibold text-gray-200">{gross_weekly}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Est. net/wk</p>
                    <p className="font-semibold text-emerald-300">{net_weekly}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        {/* Phase A vs Phase B */}
        <div className="rounded-xl border border-white/[0.07] bg-white/[0.04] p-6 mb-6">
          <h2 className="text-xl font-bold text-white mb-3">Phase A vs Phase B: Does It Affect Your Pay?</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4">
              <p className="font-bold text-amber-300 mb-2">Phase A</p>
              <ul className="space-y-1.5 text-amber-200/80">
                <li>• Wage: WML minimum applies</li>
                <li>• Public holidays: <strong className="text-amber-200">not paid</strong></li>
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4">
              <p className="font-bold text-emerald-300 mb-2">Phase B</p>
              <ul className="space-y-1.5 text-emerald-200/80">
                <li>• Wage: WML minimum + any sector uplift</li>
                <li>• Public holidays: <strong className="text-emerald-200">paid</strong> (8 days/year)</li>
        ...
        {/* Payslip errors */}
        <div className="rounded-xl border border-white/[0.07] bg-white/[0.04] p-6 mb-6">
          <h2 className="text-xl font-bold text-white mb-3">Why Your Payslip May Show Less Than Expected</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="mt-4 pt-4 border-t border-white/[0.07]">
            <Link href="/tools/payslip-checker" className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-black text-sm font-semibold px-4 py-2 rounded-lg transition-colors">
        ...
        <div className="rounded-xl border border-white/[0.07] bg-white/[0.04] p-5">
          <h2 className="text-sm font-bold text-gray-400 mb-3 uppercase tracking-wide">Salary Tools and Guides</h2>
