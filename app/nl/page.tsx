...
const AGENCYCHECK_BENEFITS = [
  { icon: "⚡", label: "Zelfde dag reactie", detail: "Solliciteer via WhatsApp en ontvang nog dezelfde dag een reactie van een echte recruiter — geen geautomatiseerde bots. Onder de Wet werk en zekerheid (WWZ) heb je als uitzendkracht recht op een schriftelijk contract vóór aanvang. Bureaus aangesloten bij ABU of NBBU zijn gebonden aan de CAO voor uitzendkrachten, die je rechten vanaf dag 1 beschermt." },
  { icon: "🏠", label: "Huisvesting met SNF-keurmerk", detail: "Alle bureaus op AgencyCheck bieden huisvesting als onderdeel van het pakket. Let op het SNF-keurmerk (Stichting Normering Flexwonen), controleerbaar op snf.nl: de maximale wettelijke inhouding is €113,50/week (2026). Transport moet als aparte post op je loonstrook staan — typisch €20–€30/week. Geen aparte regel? Vraag het schriftelijk bij het bureau." },
  { icon: "📋", label: "Transparant contract — fase-systeem", detail: "Voordat je tekent, weet je precies welke inhoudingen er zijn: huisvesting, transport, zorgverzekering. Begrijp het fase-systeem: Fase A (eerste 78 weken) geeft minder contractzekerheid; Fase B en C bieden meer rechten. De Inspectie SZW handhaaft naleving van de cao voor uitzendkrachten en WML. Meld misstanden anoniem via inspectieszw.nl." },
  { icon: "🆓", label: "100% gratis — bij wet geregeld", detail: "AgencyCheck is volledig gratis voor werknemers. De WAADI-wet verbiedt bureaus om plaatsingskosten bij werknemers in rekening te brengen. Bureaus in onze database zijn geregistreerd bij het KvK en lid van ABU of NBBU — het ABU-keurmerk is een extra kwaliteitswaarborg. Jij betaalt nooit iets, ook niet voor administratie of bemiddeling." },
];

// ─── Agency offers (NL) ──────────────────────────────────────────────────────
const AGENCY_OFFERS = [
  { icon: "📄", title: "Schriftelijk contract voor aanvang", body: "Een goed bureau geeft altijd een schriftelijk contract voordat je begint te werken. Het contract vermeldt: uurloon (min. WML €14,71/uur = €588 bruto/40u-week), huisvestingskosten, startdatum en de CAO-fase (Fase A — eerste 78 weken). Onder de Wet werk en zekerheid heb je recht op dit contract. Bureaus die dit weigeren overtreden de WAADI-wet." },
  { icon: "🏠", title: "SNF-gecertificeerde huisvesting", body: "De beste bureaus hebben SNF-certificering (Stichting Normering Flexwonen), controleerbaar op snf.nl — het onafhankelijke Nederlandse kwaliteitskeurmerk voor flexwonen. De maximale SNF-inhouding is €113,50/week (2026 norm). Transport naar het werk moet als een aparte contractregel staan (€20–€30/week), niet verborgen in andere kosten. Vraag altijd om het SNF-registratienummer." },
  { icon: "⏱", title: "Overwerktoeslag correct berekend", body: "Conform de ABU/NBBU CAO voor uitzendkrachten geldt een overwerktoeslag van 125% op weekdagen en 150% op zondagen en feestdagen. Dit moet apart zichtbaar zijn op je loonstrook als 'overwerktoeslag'. Controleer ook dat je vakantiegeld (minimaal 8% van het brutoloon, conform BW art. 7:634) correct opgebouwd wordt. De Inspectie SZW handhaaft naleving van deze CAO-rechten." },
  { icon: "🚌", title: "Transport en BSN-aanvraag geregeld", body: "De meeste bureaus regelen transport naar het werk. Zorg dat dit als aparte post op je loonstrook staat, niet verrekend in de huisvestingskosten. Je BSN (burgerservicenummer) is verplicht voor loonheffing en sociale premies — bureaus zijn verplicht je hierbij te helpen via een gemeenteafspraak. Sommige werknemers komen in aanmerking voor ET-vergoeding (extraterritoriale kosten), een belastingvrije onkostenvergoeding." },
  { icon: "🔍", title: "ABU-keurmerk en Inspectie SZW", body: "Bureaus met het ABU-keurmerk worden jaarlijks geaudit op naleving van de cao voor uitzendkrachten en de WAADI-wet. Controleer ook of het bureau geregistreerd staat in het SNA-register (Stichting Normering Arbeid) via normeringarbeid.nl. De Inspectie SZW (inspectie van het Ministerie van Sociale Zaken) handhaaft het minimumloon en kan boetes opleggen bij misstanden — melden kan anoniem." },
];
