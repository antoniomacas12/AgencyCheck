            ...
            <table className="w-full text-xs">
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  ...
                  { type: "Job interest / lead form data (placed — personal data)", period: "Anonymised after 12 months", reason: "Phone, email and recruitment data are not retained beyond 12 months. Accounting/business records required by law are retained separately for 11 years minimum (Croatian Accounting Act, Art. 10). Only data actually necessary for those accounting records is kept." },
