  ...
  if (variant === "compact") {
    return (
      <div className="my-6 flex flex-col sm:flex-row items-start sm:items-center gap-3 rounded-xl bg-[#0d1f14] border border-[#25D366]/20 px-5 py-4">
        <GateLink source="randstad-review" className="inline-flex items-center gap-2 rounded-xl bg-[#25D366] hover:bg-[#1ebe5a] active:scale-[0.97] transition-all px-5 py-3 text-sm font-black text-white shrink-0" style={{ boxShadow: "0 4px 18px rgba(37,211,102,0.28)" }}>
  ...
  if (variant === "closing") {
    return (
      <section className="mt-12 rounded-2xl bg-[#0d1f14] border border-[#25D366]/[0.18] p-7 sm:p-9 text-center">
        ...
        <GateLink source="randstad-review" className="inline-flex items-center justify-center gap-3 rounded-2xl bg-[#25D366] hover:bg-[#1ebe5a] active:scale-[0.97] transition-all px-8 py-4 text-base font-black text-white mb-4" style={{ boxShadow: "0 8px 32px rgba(37,211,102,0.30)" }}>
  ...
  return (
    <div className="my-7 rounded-2xl bg-[#0d1f14] border border-[#25D366]/[0.20] p-6">
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <GateLink source="randstad-review" className="inline-flex items-center justify-center gap-2.5 rounded-xl bg-[#25D366] hover:bg-[#1ebe5a] active:scale-[0.97] transition-all px-6 py-3.5 text-[15px] font-black text-white shrink-0 w-full sm:w-auto" style={{ boxShadow: "0 6px 24px rgba(37,211,102,0.28)" }}>
        ...
        <section className="mb-10 space-y-4">
          ...
          <div className="rounded-xl bg-gray-50 border border-gray-200 p-5">
            ...
            <div className="grid sm:grid-cols-2 gap-2">
              {[
                { href: "/otto-workforce-review", label: "OTTO Workforce review →",  sub: "Faster placement; housing for most workers" },
                { href: "/tempo-team-review",     label: "Tempo-Team review →",      sub: "Randstad Group sister brand" },
                { href: "/covebo-review",         label: "Covebo review →",          sub: "Food & logistics specialist" },
          ...
          <div className="rounded-xl bg-blue-50 border border-blue-100 p-5">
            ...
            <div className="grid sm:grid-cols-2 gap-2">
              {[
                { href: "/otto-vs-tempo-team",                       label: "OTTO vs Tempo-Team →",               sub: "Direct salary & housing comparison" },
                { href: "/compare",                                   label: "Agency comparison tool →",           sub: "Compare any two agencies side by side" },
                { href: "/randstad-jobs",                             label: "Randstad job listings →",            sub: "Current vacancies through Randstad" },
          ...
          <div className="rounded-xl bg-green-50 border border-green-100 p-5">
            ...
            <div className="grid sm:grid-cols-2 gap-2">
              {[
                ...
                { href: "/jobs-amsterdam",                     label: "Jobs in Amsterdam →",            sub: "Schiphol, Westpoort, and Noord-Holland" },
                { href: "/jobs-rotterdam",                     label: "Jobs in Rotterdam →",            sub: "Maasvlakte, Botlek, Waalhaven" },
                { href: "/check-agency",                       label: "How to check an agency →",       sub: "Verify licences and certifications" },
              ].map(({ href, label, sub }) => (
