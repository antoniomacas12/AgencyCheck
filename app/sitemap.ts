...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${BASE_URL}/nl/minimumloon-nederland-2026`, lastModified: "2026-05-01",   changeFrequency: "monthly" as const, priority: 0.85 },
    { url: `${BASE_URL}/nl/nettoloon-nederland`,        lastModified: "2026-05-01",   changeFrequency: "monthly" as const, priority: 0.85 },
    { url: `${BASE_URL}/nl/werk-met-huisvesting`,       lastModified: TODAY,          changeFrequency: "monthly" as const, priority: 0.85 },
    { url: `${BASE_URL}/nl/loonstrook-uitgelegd`,       lastModified: "2026-05-01",   changeFrequency: "monthly" as const, priority: 0.85 },
    { url: `${BASE_URL}/nl/bsn-nummer-nederland`,       lastModified: "2026-05-01",   changeFrequency: "monthly" as const, priority: 0.85 },
    { url: `${BASE_URL}/nl/et-regeling-nederland`,      lastModified: "2026-05-01",   changeFrequency: "monthly" as const, priority: 0.85 },
