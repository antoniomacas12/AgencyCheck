      ...
      <div className="bg-white border-b border-gray-200 px-6 py-5">
        <div className="max-w-7xl mx-auto flex items-start justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            {/* WhatsApp leads counter */}
            {waLeads !== null && (
              <div className="flex items-center gap-2.5 bg-[#f0fdf4] border border-[#22c55e]/30 rounded-xl px-4 py-2.5">
                <svg className="w-4 h-4 text-[#16a34a] shrink-0" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div>
                  ...
                  <p className="text-lg font-black text-gray-900 leading-none">{waLeads.count}</p>
                  {waLeads.since && (
                    <p className="text-[10px] text-gray-400 leading-none mt-0.5">
                      since {new Date(waLeads.since).toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" })}
                    </p>
                  )}
                </div>
              </div>
