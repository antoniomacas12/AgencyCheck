...
// ─── AgencyCheck benefits (PT) ───────────────────────────────────────────────
const AGENCYCHECK_BENEFITS = [
  { icon: "⚡", label: "Resposta no mesmo dia útil", detail: "Candidata-te por WhatsApp e recebe resposta de um recrutador real ainda no mesmo dia útil — o tempo típico de início é 7 a 14 dias após o primeiro contacto. Como cidadão português da UE tens livre circulação e plenos direitos laborais nos Países Baixos desde o primeiro dia de trabalho. Sem semanas de espera, sem bots automáticos." },
  { icon: "🏠", label: "Alojamento certificado SNF", detail: "Todas as agências no AgencyCheck oferecem alojamento como parte do pacote — não precisas de procurar casa num país desconhecido. A certificação SNF (verificável em snf.nl) garante que a dedução máxima é €113,50/semana (2026). Sectores comuns para portugueses: logística em Tilburg/Eindhoven e transformação alimentar. Confirma sempre a distância entre o alojamento e o local de trabalho." },
  { icon: "📋", label: "Contrato transparente antes de partir", detail: "Antes de assinares, sabes exatamente o que será descontado: alojamento, transporte (linha separada no contrato: €20–€30/sem.), seguro de saúde. Para estadias longas, é necessário registar-se no IND (Immigratie- en Naturalisatiedienst). Nota importante: o regime NHR português não é aplicável nos Países Baixos — pagamos imposto holandês (loonheffing) sobre rendimentos aqui auferidos." },
  { icon: "🆓", label: "Totalmente gratuito — garantido por lei", detail: "O AgencyCheck é 100% gratuito para os trabalhadores. A lei holandesa WAADI proíbe explicitamente cobrar taxas de colocação aos trabalhadores. As agências na nossa base estão registadas no KvK (Câmara de Comércio holandesa) e afiliadas à ABU ou NBBU. Tu não pagas nada — nem agora nem depois. Qualquer agência que cobre taxas de candidatura está a violar a lei." },
];

// ─── Agency offers (PT) ──────────────────────────────────────────────────────
const AGENCY_OFFERS = [
  { icon: "📄", title: "Contrato escrito antes de partir", body: "Uma boa agência fornece sempre contrato escrito antes de saíres de Portugal. O contrato deve especificar: taxa horária (mín. WML €14,71/h), custo do alojamento (máx. €113,50/sem. conforme SNF), data de início e fase CAO em que estás inserido (Fase A — primeiras 78 semanas). Como cidadão da UE, tens direito a exigir contrato escrito antes de qualquer deslocação." },
  { icon: "🏠", title: "Alojamento SNF certificado e verificável", body: "As melhores agências têm certificação SNF (Stichting Normering Flexwonen), verificável publicamente em snf.nl — o padrão holandês independente com dedução máxima de €113,50/semana. Portugueses trabalham frequentemente em logística (Tilburg, Eindhoven) e transformação alimentar. O transporte deve constar como linha separada no loonstrook (recibo de vencimento): tipicamente €20–€30/semana." },
  { icon: "⏱", title: "Horas extra — overwerktoeslag obrigatório", body: "Segundo o ABU/NBBU CAO, as horas extra (overwerktoeslag) são pagas a 125% em dias úteis e 150% aos domingos e feriados. As boas agências aplicam isto automaticamente e mostram claramente no loonstrook. Nota: o regime fiscal NHR português não se aplica nos Países Baixos — o imposto holandês loonheffing aplica-se desde o primeiro euro ganho em território neerlandês." },
  { icon: "🚌", title: "Transporte, BSN e registo IND", body: "A maioria das agências organiza transporte — o custo típico é €20–€30/semana e deve aparecer separado no contrato, não diluído noutras taxas. Precisas de um BSN (burgerservicenummer) para fins fiscais — a agência deve ajudar-te a agendar uma consulta na câmara (gemeente). Para estadias superiores a 4 meses, considera o registo no IND para garantir os teus direitos de residência legal." },
  { icon: "💬", title: "Apoio em português e proteção legal total", body: "As boas agências têm colaboradores que falam português e explicam cada linha do loonstrook. Como trabalhador da UE tens proteção total pelo CAO ABU/NBBU: salário mínimo garantado, overwerktoeslag correto e direito a vakantiegeld (8% do bruto, pago semestralmente). Qualquer violação pode ser denunciada à Inspectie SZW (inspectieszw.nl)." },
];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          ...
          <div className="text-center mb-10">
            <p className="mb-2 text-[10px] font-black uppercase tracking-widest text-emerald-600">
              Porquê começar pelo AgencyCheck
            </p>
            <h2 className="text-2xl sm:text-4xl font-black text-gray-900 mb-4">
              Começa a trabalhar na Holanda{" "}
              <span className="text-emerald-500">com confiança e informação</span>
            </h2>
            <p className="text-gray-500 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
              O AgencyCheck liga trabalhadores a agências verificadas que oferecem condições transparentes e pacotes justos.
            </p>
          </div>
      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          ...
          <div className="text-center mb-10">
            <p className="mb-2 text-[10px] font-black uppercase tracking-widest text-emerald-600">O que as melhores agências oferecem</p>
            <h2 className="text-2xl sm:text-4xl font-black text-gray-900 mb-4">O que incluem as ofertas das melhores agências</h2>
            <p className="text-gray-500 text-sm max-w-lg mx-auto leading-relaxed">
              Com base em {totalReviews}+ relatórios verificados de trabalhadores. Sabe o que procurar ao escolher uma agência.
            </p>
          </div>
