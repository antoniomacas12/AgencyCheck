...
const AGENCYCHECK_BENEFITS = [
  { icon: "✅", label: "Проверени агенции с реални данни", detail: "Всяка агенция в AgencyCheck е проверена спрямо публичния регистър KvK (Нидерландска търговска камара) и членството в ABU или NBBU — двете основни браншови асоциации на агенциите за временна заетост. Виждате оценки от реални работници и условия преди да решите. Директни полети от София до Нидерландия правят маршрута достъпен." },
  { icon: "🏠", label: "Жилище с SNF сертификация", detail: "Всички агенции на AgencyCheck предлагат жилище като част от пакета. Търсете SNF (Stichting Normering Flexwonen) сертификат, проверим на snf.nl — максималната законна удръжка е €113,50/седмица (2026). Много българи са настанени в Барендрехт и Уестланд, близо до оранжерийните и хранително-вкусовите предприятия." },
  { icon: "💬", label: "Разбирате своя лонстрок", detail: "Добрите агенции обясняват всяка позиция от фиша за заплата (loonstrook). Ключови термини: брутна заплата = брутo (bruto), нетна заплата = нетo (netto), надбавка за извънреден труд = overwerktoeslag. Фишът трябва да показва отделни редове за жилище, транспорт (€20–€30/седмица) и здравна застраховка." },
  { icon: "🆓", label: "Напълно безплатно — закон го гарантира", detail: "AgencyCheck е 100% безплатен за работниците. Нидерландският закон WAADI изрично забранява на агенциите да начисляват такси за намиране на работа. Агенциите в нашата база са регистрирани в KvK и спазват CAO ABU/NBBU. Вие не плащате нищо — нито при регистрация, нито по-късно." },
];
...
// ─── Agency offers (BG) ──────────────────────────────────────────────────────
const AGENCY_OFFERS = [
  { icon: "📄", title: "Писмен договор преди тръгване", body: "Добрата агенция винаги дава писмен договор предварително — преди да купите самолетен билет. Договорът трябва да съдържа: часова ставка (min. WML €14,71/ч), цена на жилището (max. €113,50/седм. по SNF), дата на старт и фаза по CAO (Фаза А — първите 78 седмици). Липсата на писмен договор преди тръгването е сигнален знак за измама." },
  { icon: "🏠", title: "SNF сертифицирано жилище — проверимо", body: "Най-добрите агенции имат SNF сертификация (проверима на snf.nl) — независим нидерландски стандарт за качество на работническо жилище с максимална удръжка €113,50/седмица. Много българи са настанени близо до Барендрехт и Уестланд, където работят в хранително-вкусовата промишленост и оранжерии — запитайте за разстоянието от жилището до работното място." },
  { icon: "⏱", title: "Извънреден труд — overwerktoeslag", body: "Съгласно ABU/NBBU CAO извънредният труд (overwerktoeslag) се заплаща с надбавка: 125% в делнични дни и 150% в неделя и официални празници. Добрите агенции прилагат това автоматично и показват ясно на лонстрока (loonstrook). Ако сте работили в почивен ден и не виждате overwerktoeslag на фиша — агенцията нарушава CAO." },
  { icon: "🚌", title: "Транспорт и регистрация в Нидерландия", body: "Повечето агенции организират транспорт до работното място — типичната цена е €20–€30/седмица и трябва да е отделен ред в договора, не скрита такса. След пристигане се нуждаете от BSN (burgerservicenummer) за данъчни цели — агенцията е длъжна да ви помогне да насрочите среща в общината (gemeente). Без BSN не може да бъдете законно наети." },
  { icon: "💬", title: "Поддръжка на български и правни гаранции", body: "Добрите агенции имат служители, говорещи български, и обясняват всяка удръжка от фиша. Като гражданин на ЕС в Нидерландия имате същите права като нидерландски работник — минимална заплата WML, защита по CAO и достъп до синдикатите FNV и CNV. Нарушения се докладват на Inspectie SZW (inspectieszw.nl)." },
];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-7">
          ...
          <div className="border-t border-white/5 pt-4">
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
              <span className="text-[9px] font-black uppercase tracking-widest text-gray-300 shrink-0">Източници на данни:</span>
              {[
            ...
            <div className="p-6 space-y-3">
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-xs font-bold text-gray-300">Какво рекламира агенцията (брутно)</span>
                  <span className="text-sm font-black text-white">€588/седмица</span>
                </div>
                <div className="h-3 rounded-full bg-white/15 w-full" />
              </div>
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-xs font-bold text-gray-300">След нидерландски данъци (с heffingskorting облекчения)</span>
                  <span className="text-sm font-black text-gray-200">€525/седмица</span>
                </div>
      ...
      <section className="bg-[#0d1728] border-b border-white/[0.05]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white mb-2">Какво реално ни казаха работниците</h2>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-7">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-white leading-tight">Намерете проверена агенция, която показва реалните удръжки</h2>
              <p className="mt-2 text-sm text-gray-500 leading-relaxed max-w-xl">
                <span className="font-semibold text-gray-200">Прозрачни удръжки</span> ·{" "}
                <span className="font-semibold text-gray-200">Проверено жилище</span> ·{" "}
                <span className="font-semibold text-gray-200">Реални отзиви от работници</span>{" "}
      ...
      <section id="calculator" className="bg-[#0d1728] border-b border-white/[0.05]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          <div className="text-center mb-9">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-white mb-3">Колко реално ще ви остане от заплатата?</h2>
            <p className="text-gray-500 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
      ...
      <section className="bg-[#0a111e] border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-white">Как изчисляваме реалната ви заплата</h2>
          </div>
      ...
      <section className="bg-[#0a111e] border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-white mb-4">Какво включват офертите на най-добрите агенции</h2>
      ...
      <section className="bg-[#0d1728] border-b border-white/[0.05]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          <div className="text-center mb-9">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-white mb-3">Вижте къде реално ще живеете</h2>
      ...
      <section className="bg-[#0a111e] border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-18">
          <div className="text-center mb-9">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-white mb-3">Прозрачни оферти — показан реален нетен доход</h2>
                  ...
                  <div className="px-5 py-4 flex-1 space-y-3">
                    ...
                    <div className="space-y-1.5 text-xs text-gray-500">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-bold text-gray-200">€{meta?.housingCost ?? 95}/седм.</span>
                      </div>
                      <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-bold text-gray-200">{meta?.responseTime ?? "< 24 часа"}</span>
                      </div>
                    </div>
                  </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-sm text-gray-300 leading-relaxed">
                <p>
                  ...
                  <strong className="text-white">€14,71/час през 2026 г.</strong> за работници
                ...
                <p>
                  Ключови правни защити, които трябва да познавате: <strong className="text-white">ABU / NBBU CAO</strong>{" "}
                  регулира заплатите, надбавките за извънреден труд и платения отпуск.
                  <strong className="text-white"> SNF</strong> (Stichting Normering Flexwonen) определя максималните законни
                  удръжки за жилище. <strong className="text-white">Inspectie SZW</strong> прилага цялото трудово законодателство.
      ...
      <section className="bg-[#0d1728] border-b border-white/[0.05]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white">Въпроси, които работниците реално задават</h2>
          </div>
          <HomepageFAQ />
