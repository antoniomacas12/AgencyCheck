...
import HeroQuickReview from "@/components/HeroQuickReview";
            ...
            <div className="hero-col-left flex-1 min-w-0 w-full max-w-2xl mx-auto lg:mx-0 text-center lg:text-left lg:pt-6">
              ...
              <div className="mt-4 w-full rounded-2xl border border-emerald-500/25 bg-[#0B1F14] px-4 py-4">
                ...
                <div className="flex flex-col gap-1.5">
                  {([
                    { slug: "cook-chef-de-partie-netherlands",  icon: "👨‍🍳", title: "Cook / Chef de Partie", salary: "€17.99–€19.00/h", note: "Hotels & resorts · Housing ~€300/mo · EU citizens" },
                    { slug: "hotel-housekeeper-netherlands",     icon: "🏨",  title: "Hotel Housekeeper",    salary: "€17.99/h",          note: "4–5★ hotels · Housing ~€400/mo · EU citizens" },
                  ] as const).map((j) => (
                    <div key={j.slug} className="rounded-xl border border-white/[0.08] bg-white/[0.02] px-3 py-2.5 flex items-center justify-between gap-2">
                      <div className="min-w-0 flex items-center gap-2">
                        <span className="text-[14px] shrink-0">{j.icon}</span>
                        <div className="min-w-0">
                          <p className="text-white font-semibold text-[12px] leading-snug truncate">{j.title}</p>
                          <p className="text-gray-500 text-[10px] truncate">{j.note}</p>
                        </div>
                      </div>
                      <div className="flex flex-col items-end gap-1.5 shrink-0">
                        <span className="text-emerald-400 font-black text-[10px] whitespace-nowrap">{j.salary}</span>
                        <a
                          href={`https://wa.me/31649210631?text=${encodeURIComponent(`Hi, I'm interested in the ${j.title} position`)}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-1 font-black text-[10px] px-2.5 py-1.5 rounded-lg bg-[#22C55E] hover:bg-green-400 active:scale-[0.97] text-white transition-all duration-150 whitespace-nowrap"
                        >
                          <svg viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 shrink-0" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                          Apply
                        </a>
                      </div>
                    </div>
              ...
              <div className="mt-4 w-full rounded-2xl border border-emerald-500/25 bg-[#0B1F14] px-4 py-4">
                ...
                <div className="flex flex-col gap-1.5">
                  {([
                    { slug: "auto-detailing-worker-netherlands", icon: "🚗", title: "Auto Detailing Worker", salary: "~€2,300–2,400 net/mo", note: "Amsterdam / Rotterdam · Housing avail. · EU citizens" },
                    { slug: "tyre-fitter-netherlands",           icon: "🔧", title: "Tyre Fitter",           salary: "€19.00–€20.50/h",     note: "Netherlands · Housing avail. · Tyre exp. required" },
                  ] as const).map((j) => (
                    <div key={j.slug} className="rounded-xl border border-white/[0.08] bg-white/[0.02] px-3 py-2.5 flex items-center justify-between gap-2">
                      <div className="min-w-0 flex items-center gap-2">
                        <span className="text-[14px] shrink-0">{j.icon}</span>
              ...
              <div className="mt-4 w-full rounded-2xl border border-emerald-500/25 bg-[#0B1F14] px-4 py-4">
                ...
                <div className="flex flex-col gap-1.5">
                  {([
                    { slug: "food-production", icon: "🧀", title: "Cheese Production",        salary: "€14.99/h", note: "Cutting · packing · 3 shifts · nights · 0–10°C · Housing paid" },
                    { slug: "food-production", icon: "🥩", title: "Meat / Meat Products",      salary: "€14.99/h", note: "Salami & more · 3 shifts · 0–10°C · Housing paid"              },
                    { slug: "food-production", icon: "🥗", title: "Salads Production",         salary: "€14.99/h", note: "Mixing & preparing · 3 shifts · 0–10°C · Housing paid"          },
                    { slug: "food-production", icon: "🫙", title: "Sauces & Dips Production", salary: "€14.99/h", note: "Hummus & similar · 3 shifts · 0–10°C · Housing paid"            },
                    { slug: "food-production", icon: "📦", title: "General Food Production",  salary: "€14.99/h", note: "Food factory · 3 shifts · 0–10°C · Housing paid"                },
                  ] as const).map((j) => (
                    <div key={`food-${j.title}`} className="rounded-xl border border-red-500/30 bg-red-500/[0.05] px-3 py-2.5 flex items-center justify-between gap-2">
                      <div className="min-w-0 flex items-center gap-2">
                        <span className="text-[14px] shrink-0">{j.icon}</span>
                        <div className="min-w-0">
                      ...
                      <div className="flex flex-col items-end gap-1.5 shrink-0">
                        <span className="text-red-400 font-black text-[10px] whitespace-nowrap">{j.salary}</span>
                        <a
                          href={`https://wa.me/31649210631?text=${encodeURIComponent(`Hi, I want to apply for: Food Production – ${j.title} (Netherlands)`)}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-1 font-black text-[10px] px-2.5 py-1.5 rounded-lg bg-red-500 hover:bg-red-400 active:scale-[0.97] text-white transition-all duration-150 whitespace-nowrap"
                        >
                          <svg viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 shrink-0" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                          Apply
                        </a>
