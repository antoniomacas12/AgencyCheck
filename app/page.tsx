...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ════════════════════════════════════════════════════════════
          §3  LEAD CAPTURE — most prominent conversion block
          ════════════════════════════════════════════════════════════ */}
            ...
            {[
              {
                ...
                body:  "Browse 127 verified agencies. Filter by housing, salary, city and worker ratings. See who actually has decent conditions.",
              },
              {
                step: "02",
                icon: "💶",
                title: "See your real pay",
                body:  "Our salary calculator shows exactly what you keep after housing, insurance, transport and all deductions. No more surprises.",
              },
              {
                step: "03",
                icon: "✅",
                title: "Apply with confidence",
                body:  "Read real worker reviews. Get matched through our free service. Sign knowing the numbers are honest and the agency is verified.",
              },
            ].map((item) => (
              <div
                key={item.step}
                className="flex flex-col gap-4 rounded-2xl border-2 border-gray-100 bg-gray-50 p-6 sm:p-8 shadow-sm"
              >
      ...
      {/* ════════════════════════════════════════════════════════════
          §5  REAL SALARY / COST TRANSPARENCY
          ════════════════════════════════════════════════════════════ */}
      <section className="bg-gray-950 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          ...
          {/* Two-column: RealSalaryBlock + breakdown table */}
          <div className="grid gap-8 lg:grid-cols-2 items-start">

            {/* Visual block from component */}
      ...
      {/* ════════════════════════════════════════════════════════════
          §6  PROOF — HOUSING PHOTOS + REVIEWS
          ════════════════════════════════════════════════════════════ */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          ...
          <div className="mb-16">
            <div className="text-center mb-10">
              ...
              <p className="mt-4 text-gray-500 text-sm sm:text-base max-w-md mx-auto">
                Worker-submitted photos and descriptions from agencies across the Netherlands.
                No stock images.
              </p>
            </div>
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/reviews"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-6 py-3.5 text-sm font-semibold text-gray-700 shadow-sm transition-colors hover:bg-gray-50"
              >
                📋 Read all {totalReviews} reviews
              </Link>
              <Link
                href="/submit-review"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-blue-700"
              >
      ...
      <section className="bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-gray-900">
              Compare the best employers
            </h2>
            <p className="mt-4 text-gray-500 text-sm sm:text-base max-w-md mx-auto">
              Scored on salary transparency, housing quality and contract fairness.
              Based on real worker data.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/agencies-with-housing"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-8 py-4 text-base font-black text-white shadow-sm transition-colors hover:bg-blue-700"
            >
              🏢 All {housingCount} housing agencies
            </Link>
            <Link
              href="/agencies"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-8 py-4 text-base font-semibold text-gray-700 shadow-sm transition-colors hover:bg-gray-50"
            >
