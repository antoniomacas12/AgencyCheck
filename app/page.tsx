          ...
          <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="w-full rounded-2xl border border-emerald-500/25 bg-[#0B1F14] px-4 py-4">
                ...
                <div className="flex flex-col gap-1.5">
                  {([
                    { slug: "food-production", icon: "🧀", title: "Cheese Production",        salary: "€14.99/h", note: "Cutting/packing · 3 shifts · nights · 0–10°C · Paid accommodation · shared double room" },
                    { slug: "food-production", icon: "🥩", title: "Meat / Meat Products",      salary: "€14.99/h", note: "Salami & similar · 3 shifts · 0–10°C · Paid accommodation · shared double room"         },
                    { slug: "food-production", icon: "🥗", title: "Salads Production",         salary: "€14.99/h", note: "Mixing & preparing · 3 shifts · 0–10°C · Paid accommodation · shared double room"       },
                    { slug: "food-production", icon: "🫙", title: "Sauces & Dips Production", salary: "€14.99/h", note: "Hummus & similar · 3 shifts · 0–10°C · Paid accommodation · shared double room"         },
                    { slug: "food-production", icon: "📦", title: "General Food Production",  salary: "€14.99/h", note: "Food factory · 3 shifts · 0–10°C · Paid accommodation · shared double room"             },
                  ] as const).map((j) => (
                    <div key={`food-${j.title}`} className="rounded-xl border border-white/[0.08] bg-white/[0.02] px-3 py-2.5 flex items-center justify-between gap-2">
                      <div className="min-w-0 flex items-center gap-2">
                        <span className="text-[14px] shrink-0">{j.icon}</span>
                        <div className="min-w-0">
