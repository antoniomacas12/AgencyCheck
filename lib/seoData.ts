...
export const CITIES: CityData[] = [
  ...
  { name: "Losser",                 slug: "losser",                 region: "Overijssel",     population: 22000  },
  ...
  { name: "Sevenum",                   slug: "sevenum",                     region: "Limburg",           population: 0  },
  { name: "Bodegraven",                slug: "bodegraven",                  region: "Zuid-Holland",      population: 0  },
  { name: "Bunschoten Spakenburg",     slug: "bunschoten-spakenburg",       region: "Utrecht",           population: 0  },
  { name: "Heinoord",                  slug: "heinoord",                    region: "Zuid-Holland",      population: 0  },
  { name: "Roosendaal",                slug: "roosendaal",                  region: "Noord-Brabant",     population: 0  },
  { name: "Obdam",                     slug: "obdam",                       region: "Noord-Holland",     population: 0  },
  { name: "Akersloot",                 slug: "akersloot",                   region: "Noord-Holland",     population: 0  },
  { name: "Hardenberg",                slug: "hardenberg",                  region: "Overijssel",        population: 0  },
  { name: "Uden",                      slug: "uden",                        region: "Noord-Brabant",     population: 0  },
  { name: "Posterholt",                slug: "posterholt",                  region: "Limburg",           population: 0  },
  { name: "Beverwijk",                 slug: "beverwijk",                   region: "Noord-Holland",     population: 0  },
  { name: "Moergestel",                slug: "moergestel",                  region: "Noord-Brabant",     population: 0  },
  { name: "Hulst",                     slug: "hulst",                       region: "Zeeland",           population: 0  },
  { name: "Antwerp",                   slug: "antwerp",                     region: "Antwerpen",         population: 0  },
  { name: "Waardenburg",               slug: "waardenburg",                 region: "Gelderland",        population: 0  },
  { name: "Oirschot",                  slug: "oirschot",                    region: "Noord-Brabant",     population: 0  },
  { name: "Oisterwijk",                slug: "oisterwijk",                  region: "Noord-Brabant",     population: 0  },
  { name: "Grubbenvorst",              slug: "grubbenvorst",                region: "Limburg",           population: 0  },
  { name: "Veghel",                    slug: "veghel",                      region: "Noord-Brabant",     population: 0  },
  { name: "Waddinxveen",               slug: "waddinxveen",                 region: "Zuid-Holland",      population: 0  },
  { name: "Ridderkerk",                slug: "ridderkerk",                  region: "Zuid-Holland",      population: 0  },
  { name: "IJmuiden",                  slug: "ijmuiden",                    region: "Noord-Holland",     population: 0  },
  { name: "Kootwijkerbroek",           slug: "kootwijkerbroek",             region: "Gelderland",        population: 0  },
  { name: "Vianen",                    slug: "vianen",                      region: "Utrecht",           population: 0  },
  { name: "Numansdorp",                slug: "numansdorp",                  region: "Zuid-Holland",      population: 0  },
  { name: "Nieuw-Bergen",              slug: "nieuw-bergen",                region: "Limburg",           population: 0  },
  { name: "Goor",                      slug: "goor",                        region: "Overijssel",        population: 0  },
  { name: "Yerseke",                   slug: "yerseke",                     region: "Zeeland",           population: 0  },
  { name: "Rhodes",                    slug: "rhodes",                      region: "South Aegean",      population: 0  },
];
...
export const JOB_SALARY_DATA: Record<string, JobSalaryData> = {
  ...
  "logistics-operator": { title: "Logistics Operator", label: "Logistics Operator", slug: "logistics-operator", icon: "📦", min: 14.71, max: 17.00, avg: 15.20, description: "Coordinating inbound and outbound goods flows in distribution centres and logistics hubs." },
  "food-production-worker": { title: "Food Production Worker", slug: "food-production-worker", icon: "🍖", min: 14.06, max: 15.50, avg: 14.30, description: "Operating production lines in food factories, packaging perishables and meeting hygiene standards in Dutch food-processing plants." },
  "meat-processing-worker": { title: "Meat Processing Worker", slug: "meat-processing-worker", icon: "🥩", min: 14.06, max: 15.00, avg: 14.10, description: "Deboning, cutting, and processing meat products under strict HACCP protocols in slaughterhouses and processing facilities across the Netherlands." },
  "logistics-coordinator":  { title: "Logistics Coordinator", slug: "logistics-coordinator", icon: "📋", min: 15.00, max: 20.00, avg: 17.00, description: "Planning transport routes, managing supplier communication, and overseeing warehouse capacity in Dutch distribution and supply-chain companies." },
  "quality-inspector":      { title: "Quality Inspector", slug: "quality-inspector", icon: "🔍", min: 14.50, max: 18.00, avg: 16.00, description: "Inspecting products on production lines against quality standards (ISO, BRC, IFS) in Dutch manufacturing and food-processing environments." },
  "packaging-worker":       { title: "Packaging Worker", slug: "packaging-worker", icon: "📦", min: 14.06, max: 15.00, avg: 14.15, description: "Manually and machine-packing consumer goods, e-commerce parcels, and food products in fulfilment centres and production sites across the Netherlands." },
  "chemical-plant-worker":  { title: "Chemical Plant Worker", slug: "chemical-plant-worker", icon: "⚗️", min: 14.50, max: 19.00, avg: 16.50, description: "Operating and monitoring chemical processing equipment in the Dutch petrochemical and specialty-chemicals industry, with mandatory VCA-P safety certification." },
  "construction-worker":    { title: "Construction Worker", slug: "construction-worker", icon: "🏗️", min: 15.00, max: 22.00, avg: 17.50, description: "General building, renovation, and civil works on residential and commercial construction sites throughout the Netherlands under the Bouw & Infra CAO." },
  "cleaner-industrial":     { title: "Industrial Cleaner", slug: "cleaner-industrial", icon: "🧹", min: 14.06, max: 15.50, avg: 14.20, description: "Deep cleaning and disinfection of factories, food-processing plants, and industrial facilities in the Netherlands under the Schoonmaak CAO." },
  // ── Johma / 4minutes partnership roles ─────────────────────────────────────
  "line-operator":          { title: "Line Operator",          slug: "line-operator",          icon: "🏭", min: 16.01, max: 21.61, avg: 16.80, description: "Monitoring and operating production lines in food manufacturing environments; responsible for quality control, line speed, and minor technical troubleshooting." },
  "food-mixing-operator":   { title: "Food Mixing Operator",   slug: "food-mixing-operator",   icon: "🍖", min: 16.01, max: 21.61, avg: 16.40, description: "Mixing and preparing ingredients according to recipes in food production facilities; requires accuracy, hygiene compliance, and attention to recipe specifications." },
  "kitchen-operator":       { title: "Kitchen Operator",       slug: "kitchen-operator",       icon: "👨‍🍳", min: 16.01, max: 21.61, avg: 16.40, description: "Preparing raw materials and operating kitchen equipment in industrial food production settings; works under strict HACCP hygiene and safety standards." },
};
