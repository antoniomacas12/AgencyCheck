...
export const JOB_SALARY_DATA: Record<string, JobSalaryData> = {
  ...
  "food-production-worker": { title: "Food Production Worker", slug: "food-production-worker", icon: "🍖", min: 14.71, max: 15.50, avg: 14.95, description: "Operating production lines in food factories, packaging perishables and meeting hygiene standards in Dutch food-processing plants." },
  "meat-processing-worker": { title: "Meat Processing Worker", slug: "meat-processing-worker", icon: "🥩", min: 14.71, max: 15.00, avg: 14.75, description: "Deboning, cutting, and processing meat products under strict HACCP protocols in slaughterhouses and processing facilities across the Netherlands." },
  ...
  "packaging-worker":       { title: "Packaging Worker", slug: "packaging-worker", icon: "📦", min: 14.71, max: 15.00, avg: 14.80, description: "Manually and machine-packing consumer goods, e-commerce parcels, and food products in fulfilment centres and production sites across the Netherlands." },
  ...
  "cleaner-industrial":     { title: "Industrial Cleaner", slug: "cleaner-industrial", icon: "🧹", min: 14.71, max: 15.50, avg: 14.85, description: "Deep cleaning and disinfection of factories, food-processing plants, and industrial facilities in the Netherlands under the Schoonmaak CAO." },
