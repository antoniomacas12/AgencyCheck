...
export const VACANCIES: Vacancy[] = [
  ...
  },
  {
    ...
    t:        "Food Production Worker – Cheese, Meat, Salads & Sauces",
    c:        "food",
    s:        "€14.99/h gross",
    sm:       600,
    sx:       0,
  ...
  },
  {
    ...
    t:        "Logistics Employee – Integralis",
    c:        "warehouse",
    s:        "Competitive salary",
    sm:       0,
    sx:       0,
    l:        "Groenlo, Netherlands",
    b:        ["acc", "car"],
    featured: true,
  },
  {
    slug:     "integralis-cleaning-groenlo",
    t:        "Cleaning Worker – Integralis",
    c:        "cleaning",
    s:        "€14.71/hr gross",
    sm:       588,
    sx:       0,
  ...
  },
  {
    ...
    t:        "Machine Operator – Integralis",
    c:        "production",
    s:        "€3,000–€3,500/mo + shift allowance",
    sm:       692,
    sx:       808,
    l:        "Hengelo, Netherlands",
    b:        ["acc"],
    featured: true,
  },
  {
    slug:     "integralis-technical-north-netherlands",
    t:        "Technical Worker (Flange / Fitter / Ironworker) – Integralis",
    c:        "technical",
    s:        "€763 net/wk (40h)",
    sm:       763,
    sx:       0,
  ...
  },
  {
    ...
    t:        "Meat Processing Worker – Integralis",
    c:        "food",
    s:        "Inquire on application",
    sm:       0,
    sx:       0,
    l:        "Groenlo, Netherlands",
    b:        ["acc"],
...
const CITY_META: Record<string, AddressMeta> = {
  ...
  "Groenlo":               { streetAddress: "Groenlo",                addressLocality: "Groenlo",                addressRegion: "Gelderland",     postalCode: "7141" },
  "Hengelo":               { streetAddress: "Hengelo",                addressLocality: "Hengelo",                addressRegion: "Overijssel",     postalCode: "7551" },
  "Groningen":             { streetAddress: "Groningen",              addressLocality: "Groningen",              addressRegion: "Groningen",      postalCode: "9711" },
  // ── Generic NL fallback ───────────────────────────────────────────────────────
