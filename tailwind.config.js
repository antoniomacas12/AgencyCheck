...
module.exports = {
  ...
  safelist: [
    ...
    "bg-brand-50",   "bg-brand-100",  "bg-brand-400",  "bg-brand-500",
    "bg-brand-600",  "bg-brand-700",  "bg-brand-800",
    "text-brand-50", "text-brand-200","text-brand-300", "text-brand-400",
    "text-brand-500","text-brand-600","text-brand-700", "text-brand-800",
    "text-brand-900",
    "border-brand-100", "border-brand-200", "border-brand-300",
    "border-brand-400", "border-brand-500", "border-brand-600",
    "ring-brand-100",   "ring-brand-200",   "ring-brand-400",   "ring-brand-500",
    "hover:bg-brand-50",  "hover:bg-brand-100", "hover:bg-brand-500",
    "hover:bg-brand-600", "hover:bg-brand-700",
    "hover:text-brand-400", "hover:text-brand-600",
    "hover:text-brand-700", "hover:text-brand-800",
    "hover:border-brand-300", "hover:border-brand-400",
    "from-brand-50", "from-brand-600", "from-brand-700",
    "from-brand-800", "from-brand-900",
    "via-brand-700",  "via-brand-800",
    "to-brand-700",   "to-brand-800",
  ],
  theme: {
    extend: {
      colors: {
