...
// Sticky bottom apply bar — mobile only (hidden on md+)
// Usage: <StickyApplyBar href="https://wa.me/..." label="Apply for C+E Truck Driver" />
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
      ...
      <div className="bg-[#0B1F14] border-t border-white/10 px-4 pb-5 pt-3">
        ...
        <p className="text-center text-gray-500 text-[11px] mt-2">
          Tap to open WhatsApp · We reply within 24h
        </p>
      </div>
    </div>
  );
