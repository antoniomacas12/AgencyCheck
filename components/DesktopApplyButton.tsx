...
export default function DesktopApplyButton({ waBase, jobTitle, source, jobId, referralMode }: Props) {
  return (
    <ApplyPreScreen waBase={waBase} jobTitle={jobTitle} source={source} jobId={jobId} referralMode={referralMode}>
      {(openFn) => (
        <button
          onClick={openFn}
